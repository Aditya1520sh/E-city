...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    // VITE_API_URL already has /api suffix, so just add /auth/google
    const apiBase =
      import.meta.env.VITE_API_URL ||
      (import.meta.env.DEV
        ? "http://localhost:3000/api"
        : "https://e-city.onrender.com/api");
    ...
    <div className="flex h-screen w-full overflow-hidden bg-slate-900 transition-colors duration-500 relative">
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
          ...
          >
            Transform how you interact with your city. Access real-time data,
            connect with your community, and shape your city's future.
          </motion.p>
          ...
          >
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs leading-relaxed">
                  Track air quality, traffic flow, weather alerts in real-time
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs leading-relaxed">
                  Report problems, track progress, get results faster
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs leading-relaxed">
                  Vote on initiatives, join events, drive positive change
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="w-full max-w-md space-y-4 sm:space-y-6 relative z-10 px-4 sm:px-0">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-slate-950 text-slate-500 font-bold text-xs uppercase tracking-wider">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <motion.button
            whileHover={{
              scale: 1.02,
              boxShadow: "0 10px 25px rgba(234, 67, 53, 0.15)",
            }}
            whileTap={{ scale: 0.98 }}
                ...
                <div
                  className={`relative w-40 h-40 rounded-2xl ${
                    unlocking
                      ...
                      : "bg-gradient-to-br from-slate-700 to-slate-900 shadow-2xl shadow-slate-900/50"
                  } flex items-center justify-center transition-all duration-300 ring-4 ${
                    unlocking ? "ring-green-400/30" : "ring-slate-600/30"
                  }`}
                >
                  {/* Lock Shackle */}
                  <motion.div
                    ...
                    className={`absolute -top-12 w-16 h-16 border-8 ${
                      unlocking ? "border-green-400" : "border-slate-600"
                    } rounded-t-full transition-colors duration-300`}
                  />
                  ...
                  <motion.div
                    ...
                    className={`${
                      unlocking ? "text-white" : "text-slate-400"
