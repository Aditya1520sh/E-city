  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        addToast(error.response.data.error || 'Invalid credentials', 'error');
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
            ...
            >
                ...
                <span className="text-2xl font-bold tracking-tight">E-DELHI <span className="text-blue-400">2.0</span></span>
            </motion.div>
            ...
            >
                Transform how you interact with Delhi. Access real-time data, connect with your community, and shape your city's future.
            </motion.p>
      ...
      >
        ...
        <div className="w-full max-w-md space-y-6 relative z-10">
            ...
            >
                ...
                <p className="text-slate-400 text-base">Enter your credentials to continue your journey</p>
            </motion.div>
            ...
            <div className="relative mt-2">
                ...
                <div className="relative flex justify-center">
                    <span className="px-4 bg-slate-950 text-slate-500 font-bold text-xs uppercase tracking-wider">Demo Accounts</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <motion.button 
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => handleQuickLogin('admin@ecity.com', 'admin')}
                    className="group relative overflow-hidden"
                >
                    {/* Animated Gradient Border */}
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 rounded-xl opacity-60 group-hover:opacity-100 blur-sm transition-all duration-300 animate-gradient-xy bg-[length:200%_200%]"></div>
                    
                    {/* Card Content */}
                    <div className="relative p-4 rounded-xl bg-slate-900 flex items-center space-x-3">
                        {/* Background Pattern */}
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-transparent dark:from-blue-950/30 dark:to-transparent rounded-xl"></div>
                        ...
                        <div className="relative flex-shrink-0">
                            <motion.div 
                                ...
                                className="w-11 h-11 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/40 group-hover:shadow-xl group-hover:shadow-blue-500/50 transition-shadow"
                            >
                        ...
                        <div className="relative flex-1 text-left">
                            <div className="flex items-center justify-between">
                                <h3 className="font-black text-sm text-white">Admin</h3>
                                <motion.span
                                    animate={{ x: [0, 3, 0] }}
                            ...
                            <p className="text-[10px] text-blue-400 font-semibold uppercase tracking-wide">Control Panel</p>
                        </div>
                    </div>
                </motion.button>
                ...
                <motion.button 
                    whileHover={{ y: -2, scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => handleQuickLogin('john@example.com', 'user')}
                    className="group relative overflow-hidden"
                >
                    {/* Animated Gradient Border */}
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-600 rounded-xl opacity-60 group-hover:opacity-100 blur-sm transition-all duration-300 animate-gradient-xy bg-[length:200%_200%]"></div>
                    
                    {/* Card Content */}
                    <div className="relative p-4 rounded-xl bg-slate-900 flex items-center space-x-3">
                        {/* Background Pattern */}
                        <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/50 to-transparent dark:from-emerald-950/30 dark:to-transparent rounded-xl"></div>
                        ...
                        <div className="relative flex-shrink-0">
                            <motion.div 
                                whileHover={{ rotate: [0, -10, 10, 0], scale: 1.1 }}
                                transition={{ duration: 0.4 }}
                                className="w-11 h-11 rounded-lg bg-gradient-to-br from-emerald-600 to-green-600 flex items-center justify-center shadow-lg shadow-emerald-500/40 group-hover:shadow-xl group-hover:shadow-emerald-500/50 transition-shadow"
                            >
                        ...
                        <div className="relative flex-1 text-left">
                            <div className="flex items-center justify-between">
                                <h3 className="font-black text-sm text-white">Citizen</h3>
                                <motion.span
                                    animate={{ x: [0, 3, 0] }}
                                    transition={{ repeat: Infinity, duration: 1.5, ease: "easeInOut" }}
                            ...
                            <p className="text-[10px] text-emerald-400 font-semibold uppercase tracking-wide">Public Access</p>
                        </div>
                    </div>
                </motion.button>
            </div>
